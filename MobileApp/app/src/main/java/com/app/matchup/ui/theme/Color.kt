...
val GENDER_MIX_COLOR = Color(0xFFFAB44D)
val LOCATION_ICON_COLOR = Color(0xFFab0303)
val MY_LOCATION_ICON_COLOR = Color(0xFF004CBB)
val RED_BUTTON = Color(0xFF880202)